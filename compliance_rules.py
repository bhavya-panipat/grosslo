...
class Rule:
    ...
    # were verified through the README's "Regulatory currency" pass rather than
    # per-rule; every rule added from now on must carry these.
    source_url: str = ""
    provision: str = ""
    verified_on: str = ""            # ISO date the citation was checked
    reviewed_by: str = ""            # who signed off; required to be ACTIVE
    reviewed_on: str = ""
