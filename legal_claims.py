...
CLAIMS: tuple = (
    ...
    Claim(
        ...
        known_divergence=(
            ...
            "DIRECTION FOR TAX: PENDING D1 (TAX_ENGINE_EMPLOYER_NPS_DESIGN.md). The engine "
            "currently double-counts employer NPS in taxable income, so whether these "
            "departures over- or under-state tax cannot be stated until that is fixed. It is "
